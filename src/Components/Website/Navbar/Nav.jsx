    ...
    return(
        ...
        <nav>
           ...
           <Modal
                ...
                <div style={{display:"flex",justifyContent:"space-around",alignItems:"center",marginTop:"20px",padding:"20px",position:"relative"}}>
                    <span style={{position:"absolute",right:"30px",top:"-40px",fontSize:"30px",cursor:"pointer"}} onClick={()=>setPop(false)}>&times;</span>
